...
- POST /admin/courses
  ...
  Input: Headers: { 'username': 'username', 'password06f74d': 'password' }, Body: { title: 'course title', description: 'course description', price: 100, imageLink: 'https://linktoimage.com' }
